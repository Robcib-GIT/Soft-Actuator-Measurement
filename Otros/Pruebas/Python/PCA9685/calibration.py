...
# oscilloscope or logic analyzer to measure the signal frequency and type the real_results into the
...
# Crea el objeto I2C correcto (esto usa el bus 1 por defecto en Jetson Nano)
...
pca.channels[SERVO].duty_cycle = 0x7FFF
time.sleep(1)
