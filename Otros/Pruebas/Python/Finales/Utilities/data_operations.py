...
def save_data_v2(data_dict: Dict[str, List[float]], results_dict: Dict[str, str]): # TODO: cambiar nombre a save_data y en los otros ficheros adaptar
    """
...
def load_data_v2() -> Tuple[Dict[str, List[float]], Dict[str, Any]]:  # TODO: cambiar nombre a load_data y en los otros ficheros adaptar
    """
